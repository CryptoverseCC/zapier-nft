    ...
    it('should load purrs', (done) => {
      ...
      appTester(App.triggers.post.operation.perform, bundle)
        .then((results) => {
          ...
          firstPurr.id.should.eql('claim:0xd87fbe04e51c55bbd90b3dcfbd48046311427038dfbb5597c533f85c5a85e7bf:0');
    ...
    it('should load likes', (done) => {
      ...
      appTester(App.triggers.like.operation.perform, bundle)
        .then((results) => {
          ...
          firstLike.id.should.eql('claim:0x9aca0b21d307aef5db67445201aff00644f0e516c839edb2d4b12379eb791c49:0');
    ...
    it('should load responses', (done) => {
      ...
      appTester(App.triggers.reply.operation.perform, bundle)
        .then((results) => {
          ...
          firstResponse.id.should.eql('claim:0x6be4ee9900813d40b4f788ee9fb0e852364317a51ab68c56f6bd11f2319034bc:0');
          firstResponse.content.should.eql('Yeah, it works https://twitter.com/Kitty_593163/status/980770904220291072');
